...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final TextEditingController _emailErrorTextController =
      TextEditingController();
  final TextEditingController _passwordErrorTextController =
      TextEditingController();
              ...
              child: Column(
                children: <Widget>[
                  ...
                  reusableTextField("Enter UserName", Icons.person_outline,
                      false, _emailTextController, _emailErrorTextController),
                  const SizedBox(
                    height: 20,
                  ),
                  reusableTextField(
